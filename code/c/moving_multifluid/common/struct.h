...
struct Parameters1d {
    ...
    double body_cross_section_divided_to_mass;// площадь к массе
    ...
    double body_left_boundary_x;// левая граница подвижного тела
    double body_right_boundary_x;// правая граница подвижного тела
    double resistive_pressure;// давление форсирования
